    ...
    <div className="card">
      ...
      <div className="card-text">
        ...
        <p>
          ...
          numquam tempora dicta consequatur perferendis nesciunt accusamus
          doloremque eum sequi.
        </p>
        <a href="#">
          Order Delivery
  ...
  return (
    <section className="specials">
      <div className="container">
        ...
        >
          <MealCard imgurl={meal1} mealName="Greek Salad" price={10.5} />
          <MealCard imgurl={meal2} mealName="Bruchetta" price={12} />
          <MealCard imgurl={meal3} mealName="Lemon Cake" price={8} />
          <MealCard imgurl={meal4} mealName="Humms" price={6} />
        </div>
      </div>
    </section>
  );
